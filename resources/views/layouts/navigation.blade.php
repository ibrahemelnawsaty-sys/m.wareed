@php
    ...
    $allItems = [
        ...
        ['route' => 'whatsapp.edit',   'owner' => true,  'label' => 'ربط واتساب',  'active' => 'whatsapp.edit', 'icon' => 'M7.5 21 3 16.5l1.2-3.6A8.25 8.25 0 1 1 7.5 21Z'],
        ['route' => 'whatsapp.guide',  'owner' => true,  'label' => 'دليل الربط',  'active' => 'whatsapp.guide', 'icon' => 'M11.25 11.25l.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z'],
